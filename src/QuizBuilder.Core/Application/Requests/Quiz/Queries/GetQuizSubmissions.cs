...
{
    public class GetQuizSubmissions : RequestBase<QuizSubmissionListDto>, IRequest<Response<GetQuizSubmissions, QuizSubmissionListDto>>
    {
        /// <summary>
        ...
        public GetQuizSubmissions(string userId, Guid quizId) : base(userId)
        {
            QuizId = quizId;
        }
