        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizSubmissions_AspNetUsers_SubmittedbyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizSubmissionId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelectedResponses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelectedResponses_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SelectedResponses_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SelectedResponses_QuizSubmissions_QuizSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizSubmissions_SubmittedbyId",
                table: "QuizSubmissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelectedResponses_AnswerId",
                table: "SelectedResponses",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedResponses_QuestionId",
                table: "SelectedResponses",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedResponses_QuizSubmissionId",
                table: "SelectedResponses",
